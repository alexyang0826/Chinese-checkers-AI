...
def build_invalid_homes_sets():
    home1 = [[0, 12], [1, 11], [1, 13], [2, 10], [2, 12], [2, 14], [3, 9], [3, 11], [3, 13], [3, 15]]
    home2 = [[4, 18], [4, 20], [4, 22], [4, 24], [5, 19], [5, 21], [5, 23], [6, 20], [6, 22], [7, 21]]
    home3 = [[9, 21], [10, 20], [10, 22], [11, 19], [11, 21], [11, 23], [12, 18], [12, 20], [12, 22], [12, 24]]
    home4 = [[13, 9], [13, 11], [13, 13], [13, 15], [14, 10], [14, 12], [14, 14], [15, 11], [15, 13], [16, 12]]
    home5 = [[9, 3], [10, 2], [10, 4], [11, 1], [11, 3], [11, 5], [12, 0], [12, 2], [12, 4], [12, 6]]
    home6 = [[4, 0], [4, 2], [4, 4], [4, 6], [5, 1], [5, 3], [5, 5], [6, 2], [6, 4], [7, 3]]
    player1_invalid_house = home2 + home3 + home5 + home6
    player2_invalid_house = home1 + home3 + home4 + home6

    return player1_invalid_house, player2_invalid_house
...
def assign_obj_set(player_turn, player1_obj, player2_obj):
...
def assign_invalid_homes_set(player_turn, player1_invalid_home, player2_invalid_home):
...
def update_player_set(set_pieces, player_turn, player1_set, player2_set):
