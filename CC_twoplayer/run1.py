...
def calculate_board_score(player_turn, p1_pieces, p2_pieces, p3_pieces, p4_pieces, p5_pieces, p6_pieces):
    p1_avg_distance,  p1_max_distance= find_avg_distance(p1_pieces, player1_obj, 16, 12)
    # print("-- avg distance p1", p1_avg_distance)
    p2_avg_distance, p2_max_distance= find_avg_distance(p2_pieces, player2_obj, 12, 0)
    # print("-- avg distance p2", p2_avg_distance)
    p3_avg_distance, p3_max_distance = find_avg_distance(p3_pieces, player3_obj, 4, 0)
    # print("-- avg distance p3", p3_avg_distance)
    p4_avg_distance, p4_max_distance = find_avg_distance(p4_pieces, player4_obj, 0, 12)
    # print("-- avg distance p4", p4_avg_distance)
    p5_avg_distance, p5_max_distance = find_avg_distance(p5_pieces, player5_obj, 4, 24)
    # print("-- avg distance p5", p5_avg_distance)
    p6_avg_distance, p6_max_distance = find_avg_distance(p6_pieces, player6_obj, 12, 24)
    ...
    score = calculate_score(player_turn, p1_avg_distance, p2_avg_distance, p3_avg_distance, p4_avg_distance,
                            p5_avg_distance, p6_avg_distance, p1_max_distance, p2_max_distance, p3_max_distance, p4_max_distance,
                            p5_max_distance, p6_max_distance)
...
def calculate_score(player_turn, p1_avg_distance, p2_avg_distance, p3_avg_distance, p4_avg_distance, p5_avg_distance,
                    p6_avg_distance, p1_max_distance, p2_max_distance, p3_max_distance, p4_max_distance,
                    p5_max_distance, p6_max_distance):
    score = 0
