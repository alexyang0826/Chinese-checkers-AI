...
def main():
    ...
    player1_invalid_home, player2_invalid_home= build_invalid_homes_sets()
    ...
    while True:
        ...
        for event in pg.event.get():
            ...
            if event.type == next_move and not game_over:
                ...
                invalid_homes_set = assign_invalid_homes_set(player_turn, player1_invalid_home, player2_invalid_home)

                # assign objective set of positions
                obj_set = assign_obj_set(player_turn, player1_obj, player2_obj)
                ...
                # update set
                player1_set, player2_set = update_player_set(set_pieces, player_turn, player1_set, player2_set)
